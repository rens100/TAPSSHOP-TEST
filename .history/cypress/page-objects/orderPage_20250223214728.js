...
const approvalOrder = 'Dziękujemy. Otrzymaliśmy Twoje zamówienie.';
...
class OrderPage {
    fillAllRequiredFields() {
        ...
        cy.get(countryDropdown).select(countryDropdownPoland, {force:});
    ...
    checkOrderFinished() {
        cy.get(approvalOrder).should("be.visible");
    }
}
