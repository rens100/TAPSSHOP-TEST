...
describe("TS1: Test AccountPage ", () => {
  ...
  it("should add procut to cart and delete it from there", function () {
    ...
    homePage.clickGoToCartFromProducyButton();
    cy.get('.cart-contents').should('contain', 'Hoodie with Zipper');
    cy.get('.remove').click();
    cy.get('.cart-contents').should('not.contain', 'Hoodie with Zipper');
